...
class NotionHelper:
    database_name_dict = {
        ...
        "CONTENT_DATABASE_NAME": "内容",
        "ALL_DATABASE_NAME": "全部",
        "IMAGE_DATABASE_NAME": "资源",
    }
    database_id_dict = {}
    image_dict = {}
    property_dict = {}
    def __init__(self):
        ...
        self.image_database_id = self.database_id_dict.get(
            self.database_name_dict.get("IMAGE_DATABASE_NAME")
        )
        r = self.client.databases.retrieve(database_id=self.content_database_id)
